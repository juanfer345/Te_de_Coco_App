...
export const generarComponentes = (styledElements) => {
  ...
  return (
    <div >
      <div style={{width:parseInt(styledElements.tamano.pageWidth, 10),height:parseInt(styledElements.tamano.pageHeight,10),position:"absolute",border:'1px black solid', marginTop:'100px'}}>
